/**
 * adfix.js — ExamReady Ad Manager (Guard Wrapper)
 * =================================================
...
(function () {
  ...
  if (window.adMgr && typeof window.adMgr.saveSlot === 'function') {
    console.log('[adfix.js] window.adMgr already defined — skipping.');
    return;
  }

  /* ── Fallback minimal implementation (only reached if admin_ad_patch.js
        is not loaded). Mirrors the full version's public API surface. ── */
  ...
  console.log('[adfix.js] window.adMgr set (fallback — admin_ad_patch.js not detected).');
})();
